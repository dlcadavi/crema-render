class Stay < ApplicationRecord
  ...
  def set_gradesmin
    ...
    if self.program_id?
      ...
      @notaminima = 0
      notas = Gradesmin.find_by(area: area, year:anno)
      if notas then @notaminima = notas.grades end
      #@notaminima = Gradesmin.find_by(area: area, year:anno).grades if self.year_enrollment != "FC"
      #ver
