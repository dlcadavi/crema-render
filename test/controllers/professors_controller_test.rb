...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference("Professor.count") do
      post professors_url, params: { professor: { email: @professor.email, id_number: @professor.id_number, lastname: @professor.lastname, name: @professor.name, phone_number: @professor.phone_number } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { email: @professor.email, id_number: @professor.id_number, lastname: @professor.lastname, name: @professor.name, phone_number: @professor.phone_number } }
